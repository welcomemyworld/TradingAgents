...
The repository already contains a batch evaluation harness in \texttt{evaluation/run\_eval.py}. This makes the proposal empirically testable inside the codebase itself.
